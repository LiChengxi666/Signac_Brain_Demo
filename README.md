...
#### Signac 基本工作流
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/1.png)
...
DensityScatter(brain, 
               ...
               quantiles = TRUE)
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot01.png)
```
VlnPlot(
  object = brain,
...
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot.png)
之后筛选出符合条件的数据：
```
brain <- subset(
  x = brain,
...
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot04.png)
#### 数据处理
...
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot02.png)
#### 峰与基因链接计算
...
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot03.png)
...
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot05.png)
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot14.png)
#### 寻找差异化标记
...
print(combined_plot)
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot07.png)
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot09.png)
...
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot11.png)
相似的代码可以用于寻找基因表达的标记：
```
DefaultAssay(brain) <- "SCT" 
...
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot08.png)
#### 转录因子足迹分析
...
```
![](https://raw.githubusercontent.com/LiChengxi666/Signac_Brain_Demo/main/plots/Rplot13.png)
### 总结
